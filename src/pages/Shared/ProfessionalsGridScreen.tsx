...
import { Search, Filter, Star, MapPin, Clock, TrendingUp, TrendingDown, Thermometer, ArrowLeft } from "lucide-react"
...
export default function ProfessionalsGridScreen() {
  const professionals = [
    {
      id: 1,
    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-orange-50">
      ...
      <div className="bg-gradient-to-r from-amber-800 to-orange-700 text-white relative overflow-hidden">
        <div className="relative p-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-xl font-bold tracking-wide">Encontrar Trancistas</h1>
          </div>
          ...
          <div className="relative mb-4">
            ...
            <Input
              ...
              className="pl-10 bg-white/95 border-2 border-amber-300 text-amber-800 font-medium placeholder:text-amber-600"
            />
          </div>
          ...
          <div className="space-y-3">
            <div className="flex gap-2 overflow-x-auto pb-2">
              <Button className="bg-amber-600 hover:bg-amber-700 text-white border-0 whitespace-nowrap font-bold">
                <Filter className="h-4 w-4 mr-1" />
                Filtros
              </Button>
              <Badge className="bg-green-600 text-white border-0 whitespace-nowrap font-bold">Disponível</Badge>
              <Badge className="bg-orange-600 text-white border-0 whitespace-nowrap font-bold">Próximas</Badge>
      ...
      <div className="p-4">
        <div className="flex items-center justify-between mb-4">
          <p className="text-sm text-amber-800 font-bold">24 profissionais encontradas</p>
          <Button variant="ghost" size="sm" className="text-amber-800 font-bold">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="relative">
                      <Avatar className="h-20 w-20 border-3 border-amber-500">
                        ...
                        <AvatarFallback className="bg-gradient-to-r from-amber-800 to-orange-800 text-white text-lg font-bold">
                          {professional.name
                            .split(" ")
                            .map((n) => n[0])
                            .join("")}
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between mb-2">
                        <div>
                          <h3 className="font-bold text-lg text-amber-900 truncate">{professional.name}</h3>
                          <div className="flex items-center gap-1 mb-2">
                            <Star className="h-4 w-4 fill-amber-500 text-amber-500" />
                            <span className="text-sm font-bold text-amber-900">{professional.rating}</span>
                            <span className="text-sm text-amber-600">({professional.reviews} avaliações)</span>
                          </div>
                        </div>
                      ...
                      <div className="bg-white/80 p-2 rounded-lg mb-3 border border-amber-200">
                        <div className="grid grid-cols-3 gap-2 text-xs">
                          <div className="text-center">
                            <p className="font-bold text-amber-900">{professional.services}</p>
                            <p className="text-amber-600">Atendimentos</p>
                          </div>
                          <div className="text-center">
                            <p className="font-bold text-amber-900">{professional.responseTime}</p>
                            <p className="text-amber-600">Resposta</p>
                          </div>
                          <div className="text-center">
                            <p className="font-bold text-amber-900">{professional.completionRate}%</p>
                            <p className="text-amber-600">Conclusão</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-1 mb-3">
                        {professional.specialties.map((specialty, index) => (
                          <Badge
                            key={index}
                            className="text-xs bg-gradient-to-r from-amber-800 to-orange-800 text-white font-bold"
                          >
                            {specialty}
                          </Badge>
                        ))}
                      ...
                      <div className="grid grid-cols-2 gap-2 text-xs text-amber-700 mb-3 font-medium">
        ...
        <div className="text-center mt-6">
          <Button className="bg-gradient-to-r from-amber-800 to-orange-800 hover:from-amber-900 hover:to-orange-900 text-white font-bold px-8 py-3">
